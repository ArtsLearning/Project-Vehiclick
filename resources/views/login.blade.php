        ...
        <div class="content-area relative z-10">
            <div class="w-full max-w-2xl px-4"> <!-- Changed from max-w-md to max-w-2xl for wider login box -->
                ...
                <div class="login-container rounded-lg p-6">
                    <p class="text-center text-gray-800 font-medium mb-4">Ayo Masuk<br>untuk melanjutkan</p>
                    
                    <form>
                        <div class="mb-4">
                            <input type="text" placeholder="Masukkan Username/Email/No. Telepon" 
                        ...
                        <button type="submit" class="w-full bg-orange-500 hover:bg-orange-600 text-white py-2 rounded font-medium transition duration-300 text-sm uppercase">Masuk</button>
                    
                        <div class="mt-4 text-center text-gray-600 text-sm">
                            <p class="mb-2">Atau masuk menggunakan</p>
                            <button class="w-full bg-white border border-gray-300 py-2 rounded flex items-center justify-center hover:bg-gray-50 text-sm">
                                <span>Google</span>
                            </button>
                        </div>
                        
                        <div class="mt-4 text-center text-gray-600 text-sm">
                            <p>Belum punya akun? Daftar <a href="#" class="text-blue-500 hover:underline">di sini</a></p>
                        </div>
                    </form>
                </div>
            </div>
